...
//        prints [I@1649a44c
//        output is the address of a number list
...
//        for (int i = 0; i < numbers.length; i++) //use length to count the quantity of number
//        {
//            System.out.println(numbers[i]);
//        }
        ...
        String[] cars = {"Volvo", "BMW", "Ford", "Mazda", "Mercedes", "GMC", "Honda", "Acura", "Audi", "Tesla", "Toyota",
                "Volkswagen", "Subaru", "Dodge", "Jeep", "Lexus", "Citroen", "Peugeot", "Porsche", "Holden", "Sachia"};
